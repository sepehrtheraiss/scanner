...
class Fetch:
    ...
    def mag_7(self):
        ...
        for ticker in MAG_7:
            data[ticker] = yf.download(ticker, period=self.period, interval=self.interval, multi_level_index=False)
        return data
    ...
    def ticker(self, tname):
        print(tname)
        print(self.period)
        print(self.interval)
        data = {}
        data[tname] = yf.download(tname, period=self.period, interval=self.interval, multi_level_index=False)
        return data
